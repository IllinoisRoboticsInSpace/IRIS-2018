...
int main(int argc, char **argv)
{
	...
	int tcpCassie = pthread_create(&tcpDave_t, NULL, main, 0);
    if(navigation || chessboard || path || fsm || comm1 || comm2 || tcpCassie)
        exit(EXIT_FAILURE);
